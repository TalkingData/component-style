<template>
    <div>
        ...
        <Divider>标签尺寸</Divider>
        <div class="app-desc">
            标签尺寸需额外设置类名 <strong>.td-tag-size-large</strong> 、<strong>.td-tag-size-default</strong> 、<strong>.td-tag-size-small</strong>
        </div>
        <Tag type="border" class="td-tag-size-large">大型标签</Tag>
        <Tag type="border" class="td-tag-size-default">默认标签</Tag>
        <Tag type="border" class="td-tag-size-small">小型标签</Tag>
    </div>
</template>
<script>
    export default {
